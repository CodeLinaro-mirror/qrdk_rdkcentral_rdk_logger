...
TEST_F(RDKLoggerDynamicTest, DynamicLoggerInitialization) {
...
TEST_F(RDKLoggerDynamicTest, DynamicLogLevelChange) {
...
TEST_F(RDKLoggerDynamicTest, DifferentLogLevels) {
    int sockfd = createTestSocket();
    ASSERT_GE(sockfd, 0) << "Failed to create test socket";
...
TEST_F(RDKLoggerDynamicTest, DifferentModuleNames) {
    int sockfd = createTestSocket();
    ASSERT_GE(sockfd, 0) << "Failed to create test socket";
...
TEST_F(RDKLoggerDynamicTest, DifferentAppNames) {
    int sockfd = createTestSocket();
    ASSERT_GE(sockfd, 0) << "Failed to create test socket";
...
TEST_F(RDKLoggerDynamicTest, MessageFormatValidation) {
    int sockfd = createTestSocket();
    ASSERT_GE(sockfd, 0) << "Failed to create test socket";
...
TEST_F(RDKLoggerDynamicTest, RapidMessages) {
    int sockfd = createTestSocket();
    ASSERT_GE(sockfd, 0) << "Failed to create test socket";
...
TEST_F(RDKLoggerDynamicTest, ConcurrentAccess) {
    int sockfd = createTestSocket();
    ASSERT_GE(sockfd, 0) << "Failed to create test socket";
...
TEST_F(RDKLoggerDynamicTest, NetworkErrors) {
...
TEST_F(RDKLoggerDynamicTest, DynamicLoggerDeinit) {
...
TEST_F(RDKLoggerDynamicTest, MalformedPackets) {
    int sockfd = createTestSocket();
    ASSERT_GE(sockfd, 0) << "Failed to create test socket";
